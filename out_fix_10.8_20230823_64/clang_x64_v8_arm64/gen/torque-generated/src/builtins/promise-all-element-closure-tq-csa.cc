...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-all-element-closure.tq?l=206&c=10
TNode<Object> PromiseAllResolveElementClosure_PromiseAllWrapResultAsFulfilledFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_value, TNode<JSFunction> p_function, TorqueStructPromiseAllWrapResultAsFulfilledFunctor_0 p_wrapResultFunctor, bool p_hasResolveAndRejectClosures) {
  ...
  if (block50.is_used()) {
    ca_.Bind(&block50);
    tmp73 = kPromiseAllResolveElementValuesSlot_0(state_);
    std::tie(tmp74, tmp75) = ContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_FixedArray_0(state_, TNode<Context>{ca_.UncheckedCast<Context>(p_context)}, TNode<IntPtrT>{tmp73}).Flatten();
    tmp76 = kEmptyFixedArray_0(state_);
    CodeStubAssembler(state_).StoreReference<FixedArray>(CodeStubAssembler::Reference{tmp74, tmp75}, tmp76);
    ca_.Goto(&block51);
  }
  ...
  if (block51.is_used()) {
    ca_.Bind(&block51);
    tmp77 = NewJSArray_0(state_, TNode<Context>{p_context}, TNode<Map>{tmp71}, TNode<FixedArrayBase>{phi_bb23_8});
    tmp78 = Undefined_0(state_);
    tmp79 = CodeStubAssembler(state_).Call(TNode<Context>{ca_.UncheckedCast<Context>(p_context)}, TNode<Object>{tmp67}, TNode<Object>{tmp78}, TNode<Object>{tmp77});
    ca_.Goto(&block48);
  }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-all-element-closure.tq?l=216&c=10
TNode<Object> PromiseAllResolveElementClosure_PromiseAllSettledWrapResultAsFulfilledFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_value, TNode<JSFunction> p_function, TorqueStructPromiseAllSettledWrapResultAsFulfilledFunctor_0 p_wrapResultFunctor, bool p_hasResolveAndRejectClosures) {
  ...
  if (block50.is_used()) {
    ...
    std::tie(tmp87, tmp88) = ContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_FixedArray_0(state_, TNode<Context>{ca_.UncheckedCast<Context>(p_context)}, TNode<IntPtrT>{tmp86}).Flatten();
  ...
  if (block51.is_used()) {
    ca_.Bind(&block51);
    tmp90 = NewJSArray_0(state_, TNode<Context>{p_context}, TNode<Map>{tmp84}, TNode<FixedArrayBase>{phi_bb23_8});
    tmp91 = Undefined_0(state_);
    tmp92 = CodeStubAssembler(state_).Call(TNode<Context>{ca_.UncheckedCast<Context>(p_context)}, TNode<Object>{tmp80}, TNode<Object>{tmp91}, TNode<Object>{tmp90});
    ca_.Goto(&block48);
  }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-all-element-closure.tq?l=226&c=10
